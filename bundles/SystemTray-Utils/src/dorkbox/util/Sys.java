...
//      you will need to recalculate the hash code and set the value of the hashCode field.
     ...
     */
    @SuppressWarnings("Duplicates")
    public static void closeQuietly(Reader inputReader)
    {
        if (inputReader != null)
        {
            try
     ...
     */
    @SuppressWarnings("Duplicates")
    public static void closeQuietly(Writer outputWriter)
    {
        if (outputWriter != null)
        {
            try
    ...
    public static byte[] charToBytes(char[] text)
    {
    ...
    public static byte[] intsToBytes(int[] ints)
    {
        ...
        for (int i = 0; i < length; i++)
        {
            ...
            {
                System.err.println(
                    "WARNING: int at index " + i + "(" + intValue + ") was not a valid byte value (0-255)");
    ...
    public static String printArrayRaw(final byte[] bytes)
    {
        return printArrayRaw(bytes, 0);
    }

    public static String printArrayRaw(final byte[] bytes, final int lineLength)
    {
        if (lineLength > 0)
        {
            int length = bytes.length;
    ...
    public static void printArray(byte[] bytes, int inputOffset, int length, boolean includeByteCount, int lineLength,
        String header)
    {
        int comma = length - 1;
    ...
    public static String getSystemString(final String property, final String defaultValue)
    {
    ...
    public static int getSystemInt(final String property, final int defaultValue)
    {
        String property1 = System.getProperty(property);
        if (property1 == null)
        {
    ...
    public static long getSystemLong(final String property, final long defaultValue)
    {
        String property1 = System.getProperty(property);
        if (property1 == null)
        {
    ...
    public static boolean getSystemBoolean(final String property, final boolean defaultValue)
    {
        String property1 = System.getProperty(property);
        if (property1 == null)
        {
    ...
    public static Color getSystemColor(final String property, final Color defaultValue)
    {
        String property1 = System.getProperty(property);
        if (property1 == null)
        {
